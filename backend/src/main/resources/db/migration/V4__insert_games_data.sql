...
-- ============================================================
INSERT INTO imagem (silaba_id, imagem, colorir, formato, deletado) VALUES
((SELECT id FROM silaba WHERE silaba = 'A' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/A_Aviao_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'A' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/A_Aviao_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'A' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/A_Aviao_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'A' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/A_Aviao_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'BA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ba_Banana_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'BA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ba_Banana_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'BA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ba_Banana_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'BA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ba_Banana_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'CA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ca_Cachorro_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'CA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ca_Cachorro_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'CA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ca_Cachorro_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'CA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ca_Cachorro_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'DA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Da_Dado_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'DA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Da_Dado_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'DA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Da_Dado_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'DA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Da_Dado_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'FA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Fa_Faca_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'FA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Fa_Faca_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'FA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Fa_Faca_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'FA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Fa_Faca_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'GA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ga_Gato_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'GA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ga_Gato_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'GA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ga_Gato_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'GA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ga_Gato_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'JA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ja_Jacare_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'JA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ja_Jacare_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'JA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ja_Jacare_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'JA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ja_Jacare_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'LA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/La_Lapis_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'LA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/La_Lapis_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'LA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/La_Lapis_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'LA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/La_Lapis_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'MA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ma_Macaco_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'MA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ma_Macaco_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'MA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ma_Macaco_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'MA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ma_Macaco_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'NA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Na_Navio_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'NA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Na_Navio_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'NA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Na_Navio_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'NA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Na_Navio_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'PA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Pa_Pato_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'PA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Pa_Pato_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'PA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Pa_Pato_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'PA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Pa_Pato_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'QUA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Qua_Quati_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'QUA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Qua_Quati_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'QUA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Qua_Quati_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'RA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ra_Rato_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'RA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ra_Rato_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'RA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ra_Rato_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'RA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ra_Rato_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'SA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Sa_Sapo_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'SA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Sa_Sapo_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'SA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Sa_Sapo_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'SA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Sa_Sapo_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'TA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ta_Tatu_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'TA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ta_Tatu_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'TA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ta_Tatu_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'TA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Ta_Tatu_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'VA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Va_Vaca_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'VA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Va_Vaca_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'VA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Va_Vaca_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'VA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Va_Vaca_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'XA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Xa_Xadrez_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'XA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Xa_Xadrez_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'XA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Xa_Xadrez_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'XA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Xa_Xadrez_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'ZA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Za_Zabumba_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'ZA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Za_Zabumba_Imagem_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'ZA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/Imagens/Za_Zabumba_Imagem_2.png', 1, 2, false);
...
-- ============================================================
INSERT INTO imagem (silaba_id, imagem, colorir, formato, deletado) VALUES
((SELECT id FROM silaba WHERE silaba = 'BO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Bo_Bolo_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'BO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Bo_Bolo_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'BO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Bo_Bolo_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'BO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Bo_Bolo_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'CO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Co_Coracao_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'CO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Co_Coracao_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'DO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Do_Doce_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'DO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Do_Doce_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'DO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Do_Doce_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'DO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Do_Doce_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'FO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Fo_Folha_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'FO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Fo_Folha_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'FO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Fo_Folha_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'FO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Fo_Folha_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'GO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Go_Goiaba_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'GO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Go_Goiaba_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'GO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Go_Goiaba_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'GO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Go_Goiaba_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'JO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Jo_Joaninha_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'JO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Jo_Joaninha_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'JO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Jo_Joaninha_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'JO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Jo_Joaninha_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'LO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Lo_Lobo_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'LO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Lo_Lobo_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'LO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Lo_Lobo_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'LO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Lo_Lobo_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'MO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Mo_Morango_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'MO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Mo_Morango_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'MO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Mo_Morango_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'MO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Mo_Morango_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'NO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/No_Noiva_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'NO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/No_Noiva_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'O' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/O_Onibus_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'O' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/O_Onibus_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'O' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/O_Onibus_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'O' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/O_Onibus_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'PO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Po_Policial_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'PO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Po_Policial_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'QUO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Quo_Quorum_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'QUO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Quo_Quorum_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'RO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Ro_Rodo_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'RO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Ro_Rodo_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'SO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/So_Sofa_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'SO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/So_Sofa_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'SO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/So_Sofa_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'SO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/So_Sofa_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'TO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/To_Tomate_Foto_1.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'TO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/To_Tomate_Foto_2.png', 1, 1, false),
((SELECT id FROM silaba WHERE silaba = 'TO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/To_Tomate_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'TO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/To_Tomate_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'VO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Vo_Vovo_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'VO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Vo_Vovo_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'XO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Xo_Xororo_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'XO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Xo_Xororo_Imagem_2.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'ZO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Zo_Zoologico_Imagem_1.png', 1, 2, false),
((SELECT id FROM silaba WHERE silaba = 'ZO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/Imagens/Zo_Zoologico_Imagem_2.png', 1, 2, false);

-- ============================================================
-- Imagens do Jogo Colorir - Vogal A
-- estagio=1, colorir=2 (JOGO_COLORIR), formato=2 (DESENHO)
-- ============================================================
INSERT INTO imagem (silaba_id, imagem, mascara, colorir, formato, deletado) VALUES
((SELECT id FROM silaba WHERE silaba = 'A' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/A_Avião_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/A_Avião_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'A' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/A_Avião_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/A_Avião_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'BA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ba_Banana_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ba_Banana_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'BA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ba_Banana_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ba_Banana_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'CA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ca_Cachorro_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ca_Cachorro_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'CA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ca_Cachorro_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ca_Cachorro_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'DA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Da_Dado_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Da_Dado_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'DA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Da_Dado_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Da_Dado_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'FA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Fa_Faca_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Fa_Faca_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'FA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Fa_Faca_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Fa_Faca_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'GA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ga_Gato_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ga_Gato_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'GA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ga_Gato_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ga_Gato_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'JA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ja_Jacaré_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ja_Jacaré_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'JA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ja_Jacaré_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ja_Jacaré_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'LA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/La_Lápis_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/La_Lápis_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'LA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/La_Lápis_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/La_Lápis_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'MA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ma_Macaco_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ma_Macaco_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'MA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ma_Macaco_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ma_Macaco_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'NA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Na_Navio_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Na_Navio_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'NA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Na_Navio_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Na_Navio_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'PA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Pa_Pato_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Pa_Pato_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'PA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Pa_Pato_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Pa_Pato_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'QUA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Qua_Quati_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Qua_Quati_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'QUA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Qua_Quati_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Qua_Quati_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'RA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ra_Rato_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ra_Rato_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'RA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ra_Rato_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ra_Rato_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'SA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Sa_Sapo_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Sa_Sapo_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'SA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Sa_Sapo_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Sa_Sapo_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'TA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ta_Tatu_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ta_Tatu_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'TA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Ta_Tatu_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Ta_Tatu_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'VA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Va_Vaca_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Va_Vaca_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'VA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Va_Vaca_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Va_Vaca_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'XA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Xa_Xadrez_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Xa_Xadrez_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'XA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Xa_Xadrez_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Xa_Xadrez_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'ZA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Za_Zabumba_Colorir_1.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Za_Zabumba_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'ZA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Imagens/Za_Zabumba_Colorir_2.png', 'http://localhost:3100/assets/Vogal_A/ImagensJogoColorir/Masks/Za_Zabumba_Colorir_2_mask.png', 2, 2, false);
...
-- ============================================================
INSERT INTO imagem (silaba_id, imagem, mascara, colorir, formato, deletado) VALUES
((SELECT id FROM silaba WHERE silaba = 'BO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Bo_Bolo_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Bo_Bolo_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'BO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Bo_Bolo_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Bo_Bolo_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'CO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Co_Coração_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Co_Coração_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'CO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Co_Coração_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Co_Coração_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'DO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Do_Doce_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Do_Doce_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'DO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Do_Doce_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Do_Doce_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'FO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Fo_Folha_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Fo_Folha_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'FO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Fo_Folha_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Fo_Folha_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'GO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Go_Goiaba_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Go_Goiaba_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'GO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Go_Goiaba_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Go_Goiaba_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'JO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Jo_Joaninha_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Jo_Joaninha_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'JO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Jo_Joaninha_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Jo_Joaninha_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'LO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Lo_Lobo_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Lo_Lobo_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'LO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Lo_Lobo_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Lo_Lobo_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'MO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Mo_Morango_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Mo_Morango_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'MO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Mo_Morango_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Mo_Morango_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'NO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/No_Noiva_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/No_Noiva_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'NO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/No_Noiva_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/No_Noiva_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'O' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/O_Ônibus_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/O_Ônibus_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'O' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/O_Ônibus_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/O_Ônibus_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'PO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Po_Policial_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Po_Policial_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'PO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Po_Policial_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Po_Policial_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'QUO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Quo_Quorum_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Quo_Quorum_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'QUO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Quo_Quorum_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Quo_Quorum_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'RO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Ro_Rodo_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Ro_Rodo_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'RO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Ro_Rodo_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Ro_Rodo_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'SO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/So_Sofá_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/So_Sofá_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'SO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/So_Sofá_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/So_Sofá_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'TO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/To_Tomate_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/To_Tomate_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'TO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/To_Tomate_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/To_Tomate_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'VO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Vo_Vovô_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Vo_Vovô_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'VO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Vo_Vovô_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Vo_Vovô_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'XO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Xo_Xororó_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Xo_Xororó_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'XO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Xo_Xororó_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Xo_Xororó_Colorir_2_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'ZO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Zo_Zoológico_Colorir_1.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Zo_Zoológico_Colorir_1_mask.png', 2, 2, false),
((SELECT id FROM silaba WHERE silaba = 'ZO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Imagens/Zo_Zoológico_Colorir_2.png', 'http://localhost:3100/assets/Vogal_O/ImagensJogoColorir/Masks/Zo_Zoológico_Colorir_2_mask.png', 2, 2, false);
...
-- ============================================================
INSERT INTO imagem (silaba_id, imagem, colorir, formato, cena_id, deletado) VALUES
((SELECT id FROM silaba WHERE silaba = 'A' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/A_Avião_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/avião1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'A' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/A_Avião_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/avião1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'A' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/A_Avião_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/avião2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'A' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/A_Avião_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/avião2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'BA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ba_Banana_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/banana1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'BA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ba_Banana_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/banana1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'BA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ba_Banana_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/banana2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'BA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ba_Banana_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/banana2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'CA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ca_Cachorro_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/cachorro1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'CA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ca_Cachorro_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/cachorro1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'CA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ca_Cachorro_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/cachorro2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'CA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ca_Cachorro_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/cachorro2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'DA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Da_Dado_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/dado1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'DA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Da_Dado_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/dado1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'DA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Da_Dado_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/dado2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'DA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Da_Dado_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/dado2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'FA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Fa_Faca_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/faca1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'FA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Fa_Faca_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/faca1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'FA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Fa_Faca_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/faca2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'FA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Fa_Faca_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/faca2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'GA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ga_Gato_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/gato1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'GA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ga_Gato_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/gato1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'GA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ga_Gato_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/gato2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'GA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ga_Gato_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/gato2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'JA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ja_Jacaré_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/jacaré1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'JA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ja_Jacaré_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/jacaré1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'JA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ja_Jacaré_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/jacaré2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'JA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ja_Jacaré_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/jacaré2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'LA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/La_Lápis_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/lápis1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'LA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/La_Lápis_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/lápis1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'LA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/La_Lápis_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/lápis2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'LA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/La_Lápis_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/lápis2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'MA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ma_Macaco_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/macaco1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'MA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ma_Macaco_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/macaco1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'MA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ma_Macaco_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/macaco2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'MA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ma_Macaco_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/macaco2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'NA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Na_Navio_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/navio1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'NA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Na_Navio_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/navio1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'NA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Na_Navio_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/navio2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'NA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Na_Navio_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/navio2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'PA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Pa_Pato_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/pato1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'PA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Pa_Pato_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/pato1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'PA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Pa_Pato_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/pato2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'PA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Pa_Pato_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/pato2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'QUA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Qua_Quati_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/quati1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'QUA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Qua_Quati_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/quati1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'QUA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Qua_Quati_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/quati2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'QUA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Qua_Quati_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/quati2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'RA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ra_Rato_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/rato1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'RA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ra_Rato_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/rato1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'RA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ra_Rato_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/rato2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'RA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ra_Rato_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/rato2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'SA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Sa_Sapo_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/sapo1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'SA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Sa_Sapo_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/sapo1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'SA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Sa_Sapo_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/sapo2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'SA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Sa_Sapo_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/sapo2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'TA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ta_Tatu_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/tatu1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'TA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ta_Tatu_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/tatu1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'TA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ta_Tatu_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/tatu2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'TA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Ta_Tatu_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/tatu2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'VA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Va_Vaca_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/vaca1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'VA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Va_Vaca_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/vaca1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'VA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Va_Vaca_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/vaca2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'VA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Va_Vaca_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/vaca2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'XA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Xa_Xadrez_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/xadrez1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'XA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Xa_Xadrez_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/xadrez1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'XA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Xa_Xadrez_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/xadrez2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'XA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Xa_Xadrez_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/xadrez2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'ZA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Za_Zabumba_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/zabumba1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'ZA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Za_Zabumba_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/zabumba1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'ZA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Za_Zabumba_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/zabumba2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'ZA' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'A')), 'http://localhost:3100/assets/Vogal_A/ImagensCliqueColorir/Imagens/Za_Zabumba_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_A/zabumba2.tscn'), false);
...
INSERT INTO imagem (silaba_id, imagem, colorir, formato, cena_id, deletado) VALUES
-- BO - Bolo
((SELECT id FROM silaba WHERE silaba = 'BO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Bo_Bolo_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/bolo1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'BO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Bo_Bolo_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/bolo1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'BO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Bo_Bolo_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/bolo2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'BO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Bo_Bolo_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/bolo2.tscn'), false),
-- CO - Coração
((SELECT id FROM silaba WHERE silaba = 'CO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Co_Coração_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/coração1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'CO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Co_Coração_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/coração1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'CO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Co_Coração_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/coração2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'CO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Co_Coração_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/coração2.tscn'), false),
-- DO - Doce
((SELECT id FROM silaba WHERE silaba = 'DO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Do_Doce_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/doce1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'DO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Do_Doce_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/doce1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'DO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Do_Doce_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/doce2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'DO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Do_Doce_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/doce2.tscn'), false),
-- FO - Folha
((SELECT id FROM silaba WHERE silaba = 'FO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Fo_Folha_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/folha1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'FO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Fo_Folha_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/folha1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'FO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Fo_Folha_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/folha2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'FO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Fo_Folha_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/folha2.tscn'), false),
-- GO - Goiaba
((SELECT id FROM silaba WHERE silaba = 'GO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Go_Goiaba_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/goiaba1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'GO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Go_Goiaba_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/goiaba1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'GO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Go_Goiaba_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/goiaba2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'GO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Go_Goiaba_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/goiaba2.tscn'), false),
-- JO - Joaninha
((SELECT id FROM silaba WHERE silaba = 'JO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Jo_Joaninha_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/joaninha1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'JO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Jo_Joaninha_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/joaninha1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'JO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Jo_Joaninha_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/joaninha2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'JO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Jo_Joaninha_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/joaninha2.tscn'), false),
-- LO - Lobo
((SELECT id FROM silaba WHERE silaba = 'LO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Lo_Lobo_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/lobo1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'LO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Lo_Lobo_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/lobo1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'LO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Lo_Lobo_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/lobo2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'LO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Lo_Lobo_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/lobo2.tscn'), false),
-- MO - Morango
((SELECT id FROM silaba WHERE silaba = 'MO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Mo_Morango_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/morango1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'MO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Mo_Morango_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/morango1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'MO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Mo_Morango_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/morango2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'MO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Mo_Morango_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/morango2.tscn'), false),
-- NO - Noiva
((SELECT id FROM silaba WHERE silaba = 'NO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/No_Noiva_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/noiva1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'NO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/No_Noiva_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/noiva1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'NO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/No_Noiva_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/noiva2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'NO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/No_Noiva_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/noiva2.tscn'), false),
-- O - Ônibus
((SELECT id FROM silaba WHERE silaba = 'O' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/O_Ônibus_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/ônibus1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'O' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/O_Ônibus_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/ônibus1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'O' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/O_Ônibus_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/ônibus2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'O' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/O_Ônibus_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/ônibus2.tscn'), false),
-- PO - Policial
((SELECT id FROM silaba WHERE silaba = 'PO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Po_Policial_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/policial1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'PO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Po_Policial_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/policial1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'PO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Po_Policial_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/policial2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'PO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Po_Policial_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/policial2.tscn'), false),
-- QUO - Quorum
((SELECT id FROM silaba WHERE silaba = 'QUO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Quo_Quorum_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/quorum1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'QUO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Quo_Quorum_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/quorum1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'QUO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Quo_Quorum_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/quorum2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'QUO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Quo_Quorum_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/quorum2.tscn'), false),
-- RO - Rodo
((SELECT id FROM silaba WHERE silaba = 'RO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Ro_Rodo_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/rodo1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'RO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Ro_Rodo_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/rodo1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'RO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Ro_Rodo_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/rodo2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'RO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Ro_Rodo_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/rodo2.tscn'), false),
-- SO - Sofá
((SELECT id FROM silaba WHERE silaba = 'SO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/So_Sofá_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/sofá1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'SO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/So_Sofá_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/sofá1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'SO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/So_Sofá_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/sofá2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'SO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/So_Sofá_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/sofá2.tscn'), false),
-- TO - Tomate
((SELECT id FROM silaba WHERE silaba = 'TO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/To_Tomate_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/tomate1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'TO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/To_Tomate_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/tomate1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'TO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/To_Tomate_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/tomate2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'TO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/To_Tomate_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/tomate2.tscn'), false),
-- VO - Vovô
((SELECT id FROM silaba WHERE silaba = 'VO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Vo_Vovô_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/vovô1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'VO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Vo_Vovô_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/vovô1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'VO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Vo_Vovô_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/vovô2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'VO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Vo_Vovô_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/vovô2.tscn'), false),
-- XO - Xororó
((SELECT id FROM silaba WHERE silaba = 'XO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Xo_Xororó_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/xororó1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'XO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Xo_Xororó_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/xororó1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'XO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Xo_Xororó_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/xororó2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'XO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Xo_Xororó_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/xororó2.tscn'), false),
-- ZO - Zoológico
((SELECT id FROM silaba WHERE silaba = 'ZO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Zo_Zoológico_1_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/zoológico1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'ZO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Zo_Zoológico_1_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/zoológico1.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'ZO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Zo_Zoológico_2_Imagem_1.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/zoológico2.tscn'), false),
((SELECT id FROM silaba WHERE silaba = 'ZO' AND vogal_id = (SELECT id FROM vogal WHERE vogal = 'O')), 'http://localhost:3100/assets/Vogal_O/ImagensCliqueColorir/Imagens/Zo_Zoológico_2_Imagem_2.png', 3, 2, (SELECT id FROM cena WHERE cena = 'res://scenes/imagens/Silabas_O/zoológico2.tscn'), false);
...
-- ============================================================
INSERT INTO imagem (palavra_id, imagem, colorir, formato, deletado) VALUES
-- ARARA (sílaba de referência: A)
((SELECT id FROM palavra WHERE palavra = 'ARARA'), 'http://localhost:3100/assets/Vogal_A/ImagensPalavras/A_Arara_Foto_1.png',    1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'ARARA'), 'http://localhost:3100/assets/Vogal_A/ImagensPalavras/A_Arara_Imagem_1.png',  1, 2, false),

-- BALA (sílaba BA)
((SELECT id FROM palavra WHERE palavra = 'BALA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ba_Bala_Foto_1.png',    1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'BALA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ba_Bala_Imagem_1.png',  1, 2, false),

-- BANANA (sílaba BA)
((SELECT id FROM palavra WHERE palavra = 'BANANA'), 'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ba_Banana_Foto_1.png',  1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'BANANA'), 'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ba_Banana_Foto_2.png',  1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'BANANA'), 'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ba_Banana_Imagem_1.png',1, 2, false),
((SELECT id FROM palavra WHERE palavra = 'BANANA'), 'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ba_Banana_Imagem_2.png',1, 2, false),

-- BATATA (sílaba BA)
((SELECT id FROM palavra WHERE palavra = 'BATATA'), 'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ba_Batata_Foto_1.png',  1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'BATATA'), 'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ba_Batata_Imagem_1.png',1, 2, false),

-- CAMA (sílaba CA)
((SELECT id FROM palavra WHERE palavra = 'CAMA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ca_Cama_Foto_1.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'CAMA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ca_Cama_Imagem_1.png', 1, 2, false),

-- FACA (sílaba FA)
((SELECT id FROM palavra WHERE palavra = 'FACA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Fa_Faca_Foto_1.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'FACA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Fa_Faca_Foto_2.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'FACA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Fa_Faca_Imagem_1.png', 1, 2, false),
((SELECT id FROM palavra WHERE palavra = 'FACA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Fa_Faca_Imagem_2.png', 1, 2, false),

-- LATA (sílaba LA)
((SELECT id FROM palavra WHERE palavra = 'LATA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/La_Lata_Imagem_1.png', 1, 2, false),
((SELECT id FROM palavra WHERE palavra = 'LATA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/La_Lata_Imagem_2.png', 1, 2, false),

-- MALA (sílaba MA)
((SELECT id FROM palavra WHERE palavra = 'MALA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ma_Mala_Foto_1.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'MALA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Ma_Mala_Imagem_1.png', 1, 2, false),

-- SALADA (sílaba SA)
((SELECT id FROM palavra WHERE palavra = 'SALADA'), 'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Sa_Salada_Foto_1.png', 1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'SALADA'), 'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Sa_Salada_Imagem_1.png',1, 2, false),

-- VACA (sílaba VA)
((SELECT id FROM palavra WHERE palavra = 'VACA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Va_Vaca_Foto_1.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'VACA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Va_Vaca_Foto_2.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'VACA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Va_Vaca_Imagem_1.png', 1, 2, false),
((SELECT id FROM palavra WHERE palavra = 'VACA'),   'http://localhost:3100/assets/Vogal_A/ImagensPalavras/Va_Vaca_Imagem_2.png', 1, 2, false),

-- BOLA (vogal O)
((SELECT id FROM palavra WHERE palavra = 'BOLA'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Bo_Bola_Foto_1.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'BOLA'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Bo_Bola_Imagem_1.png', 1, 2, false),

-- BOLO (vogal O)
((SELECT id FROM palavra WHERE palavra = 'BOLO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Bo_Bolo_Foto_1.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'BOLO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Bo_Bolo_Foto_2.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'BOLO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Bo_Bolo_Imagem_1.png', 1, 2, false),
((SELECT id FROM palavra WHERE palavra = 'BOLO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Bo_Bolo_Imagem_2.png', 1, 2, false),

-- CAVALO (vogal O)
((SELECT id FROM palavra WHERE palavra = 'CAVALO'), 'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Ca_Cavalo_Foto_1.png', 1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'CAVALO'), 'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Ca_Cavalo_Imagem_1.png',1, 2, false),

-- COCO (vogal O)
((SELECT id FROM palavra WHERE palavra = 'COCO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Co_Coco_Foto_1.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'COCO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Co_Coco_Imagem_1.png', 1, 2, false),

-- COPO (vogal O)
((SELECT id FROM palavra WHERE palavra = 'COPO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Co_Copo_Foto_1.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'COPO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Co_Copo_Imagem_1.png', 1, 2, false),

-- GATO (vogal O — arquivo está na pasta Vogal_O conforme print)
((SELECT id FROM palavra WHERE palavra = 'GATO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Ga_Gato_Foto_1.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'GATO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Ga_Gato_Foto_2.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'GATO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Ga_Gato_Imagem_1.png', 1, 2, false),
((SELECT id FROM palavra WHERE palavra = 'GATO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Ga_Gato_Imagem_2.png', 1, 2, false),

-- MACACO (vogal O)
((SELECT id FROM palavra WHERE palavra = 'MACACO'), 'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Ma_Macaco_Foto_1.png', 1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'MACACO'), 'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Ma_Macaco_Foto_2.png', 1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'MACACO'), 'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Ma_Macaco_Imagem_1.png',1, 2, false),
((SELECT id FROM palavra WHERE palavra = 'MACACO'), 'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Ma_Macaco_Imagem_2.png',1, 2, false),

-- MOTO (vogal O)
((SELECT id FROM palavra WHERE palavra = 'MOTO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Mo_Moto_Foto_1.png',   1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'MOTO'),   'http://localhost:3100/assets/Vogal_O/ImagensPalavras/Mo_Moto_Imagem_1.png', 1, 2, false),

-- OVO (vogal O)
((SELECT id FROM palavra WHERE palavra = 'OVO'),    'http://localhost:3100/assets/Vogal_O/ImagensPalavras/O_Ovo_Foto_1.png',     1, 1, false),
((SELECT id FROM palavra WHERE palavra = 'OVO'),    'http://localhost:3100/assets/Vogal_O/ImagensPalavras/O_Ovo_Imagem_1.png',   1, 2, false);
